...
class AppController extends BaseController {
    ...
    public function loginAction(Request $request) {
        ...
        if (!$user) {
            return new View(array('success' => false, 'error' => 'Invalid user'), Response::HTTP_OK);
        }

        if (!$user->getActive())
        {
            return new View(array('success' => false, 'error' => 'The user is not activated'), Response::HTTP_OK);
        }

        // password check
        if (!$this->get('security.password_encoder')->isPasswordValid($user, $password)) {
            return new View(array('success' => false, 'error' => 'Invalid password'), Response::HTTP_OK);
        }
    ...
    public function logoutAction(Request $request) {
        ...
        if (!$user) {
            return new View(array('success' => false, 'error' => 'Invalid token', 'code' => 3000), Response::HTTP_OK);
        }
